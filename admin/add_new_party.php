        ...
        <div class="widget-content nopadding">
          <form name="form1" action="" method="post" class="form-horizontal">
            ...
            <div class="alert alert-danger" id="error" style="display:none;">
                This Party Already Exist! Please Try Another.
            </div>
              ...
              <tbody>
                ...
                while($row=mysqli_fetch_array($res))
                {
                    ...
                    <tr>
                        ...
                        <td><center><a class="btn btn-success" href="edit_party.php?id=<?php echo $row["id"]; ?>">Edit</a></center></td>
                        <td><center><a class="btn btn-danger" href="delete_party.php?id=<?php echo $row["id"]; ?>">Delete</a></center></td>
                </tr>
                    <?php
                }
                ?>
  ...
  $count=0;
    ...
    if($count>0)
    {
      ...
      <?php
        ...
        mysqli_query($link,"insert into party_info value(NULL,'$_POST[firstname]','$_POST[lastname]','$_POST[businessname]','$_POST[contact]','$_POST[address]','$_POST[city]')") or die(mysqli_error($link));
